    ...
    render(){
        ...
        <div className="card"> 
         <div className="container">
                <h3>{this.props.movie.title}</h3><button onClick={this.toggleShowDetails}>Add to Playlist</button>
                {this.state.showPlaylists && 
                <div> <PlaylistList 
                name={this.props.name} 
                handlePlaylistForm={this.props.handlePlaylistForm}
                createPlaylists={this.props.createPlaylists}
                playlists={this.props.playlists} /></div> }
                <h5>Original Title: {this.props.movie.original_title}</h5>
                <img alt="movie poster" width="200" height="250" src={this.props.movie.poster_path === null ? defaultImage : image + this.props.movie.poster_path}/>
